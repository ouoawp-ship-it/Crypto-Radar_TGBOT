...
PRESERVE_KEYS = {
    ...
    "LIFECYCLE_INTELLIGENCE_ENABLE",
    "LIFECYCLE_INTELLIGENCE_INTERVAL_SEC",
    "LIFECYCLE_REPLAY_INTERVAL_SEC",
    "LIFECYCLE_ANALYTICS_INTERVAL_SEC",
    "LIFECYCLE_SIMILARITY_MIN_SAMPLES",
