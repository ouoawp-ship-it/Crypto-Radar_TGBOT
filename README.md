...
这是一个只面向 Telegram 信号推送的加密市场监控项目。v2.6.1 新增独立的 1H 箱体临界预警：以已闭合 15m K 线优先、1H K 线兜底扫描冻结箱体上下沿，并标注同侧 4H/1D/1W 共振。v2.6.0 的资金流 P1.1 分类、自适应 1D 盘整产品、脉冲雷达严格加密资产池、全量 15 分钟覆盖以及跨服务统一缓存/限流保持不变。
