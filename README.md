...
项目版本号写在 `VERSION` 文件里，当前为 `v1.40.0`，后续功能更新按 `v1.41.0`、`v2.0` 递增；中文菜单检查/更新时会同时显示版本号和 git 提交号。
