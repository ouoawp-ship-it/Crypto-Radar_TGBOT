...
class WebConsoleTests(unittest.TestCase):
    ...
    def test_index_localizes_bool_options_and_explains_actions(self) -> None:
        ...
        self.assertIn('data-ui-version="v1.70.3"', html)
    ...
    def test_public_frontend_and_admin_entrypoints_are_split(self) -> None:
        ...
        self.assertIn("filterWindow", web.PUBLIC_INDEX_HTML)
        self.assertIn("filterQ", web.PUBLIC_INDEX_HTML)
        self.assertIn("data-open-coin", web.PUBLIC_INDEX_HTML)
        ...
        self.assertIn("登录失败次数过多", web.INDEX_HTML)
        self.assertIn("当前用户", web.INDEX_HTML)
        self.assertIn("会话到期", web.INDEX_HTML)
        self.assertIn("剩余时间", web.INDEX_HTML)
        ...
        self.assertNotIn("WEB_SESSION_SECRET", web.INDEX_HTML)
        self.assertNotIn("WEB_ADMIN_PASSWORD_HASH", web.INDEX_HTML)
        self.assertNotIn("明文密码", web.INDEX_HTML)
