...
from paopao_radar.funding_alert import FundingAlertEngine
from paopao_radar.funding_flip_oi import (
    HOUR_MS,
...
class FundingFlipOIDeliveryIntegrationTests(unittest.TestCase):
    ...
    def _build_pending(
        ...
        with patch("paopao_radar.funding_alert.time.time", return_value=NOW_TS):
        ...
        with patch(
            "paopao_radar.funding_alert.time.time",
