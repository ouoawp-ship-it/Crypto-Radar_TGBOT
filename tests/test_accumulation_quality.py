...
from paopao_radar.accumulation_quality import (
    DAY_MS,
...
class AccumulationQualityTests(unittest.TestCase):
    ...
    def test_requires_45_day_baseline_plus_7_recent_days(self) -> None:
        ...
        self.assertFalse(accumulation_quality_allows_ambush(
            {"eligible": True, "sideways_days": 44},
            min_baseline_days=45,
        ))
        self.assertTrue(accumulation_quality_allows_ambush(
            allowed,
            min_baseline_days=45,
        ))
