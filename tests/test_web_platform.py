...
class PublicContextContractTests(unittest.TestCase):
    ...
    def test_public_routes_include_context_and_snapshot(self) -> None:
        ...
        self.assertIn("/public-api/workstation/funds/overview", source)
        self.assertIn("/public-api/workstation/funds/open-interest", source)
        self.assertIn("/public-api/workstation/funds/sectors", source)
        self.assertIn("/public-api/workstation/funds/assets", source)
        self.assertIn("/public-api/workstation/funds/series", source)
        self.assertIn("/public-api/workstation/info/dashboard", source)
