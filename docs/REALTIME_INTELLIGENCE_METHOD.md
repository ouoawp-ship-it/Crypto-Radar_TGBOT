...
- Binance USDⓈ-M Market Streams：<https://developers.binance.com/en/docs/products/derivatives-trading-usds-futures/websocket-market-streams/Connect>。使用路由后的 `wss://fstream.binance.com/market/ws`；未路由旧地址已于 2026-04-23 停止推送 market 类事件。
