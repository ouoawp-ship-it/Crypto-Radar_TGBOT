    ...
    <header className="sticky top-0 z-30 border-b border-white/10 bg-surface-950/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <Link href="/" className="flex items-center gap-3">
          <div className="grid h-10 w-10 place-items-center rounded-2xl border border-cyanline/40 bg-cyanline/10 text-lg font-black text-cyan-200">
            P
          </div>
          <div>
            <div className="text-base font-black tracking-wide text-white">Paoxx 信号雷达</div>
            <div className="text-xs text-slate-400">加密市场信号、决策、结果追踪与回测仪表盘</div>
          </div>
        </Link>
