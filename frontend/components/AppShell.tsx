...
export function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="app-shell min-h-dvh bg-surface-canvas">
      ...
      <Header />
      <div className="site-content mx-auto w-full max-w-[1280px] px-3 pb-28 pt-4 sm:px-5 md:pb-10 lg:px-6">
        <main className="min-w-0" id="main-content" tabIndex={-1}>{children}</main>
      </div>
      <footer className="site-footer hidden border-t border-border-subtle bg-surface-low px-4 py-4 text-center text-[11px] text-text-muted md:block">
