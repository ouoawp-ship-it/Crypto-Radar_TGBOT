...
function MomentumBoard({ board, momentum, onSelectSymbol, realtimeBySymbol }: { board?: CockpitBoard; momentum: Partial<Record<WindowKey, RadarBoards>>; onSelectSymbol: (symbol: string) => void; realtimeBySymbol: Map<string, RealtimeIntelligenceItem> }) {
  ...
  return <section className="overflow-hidden rounded-[2px] border border-border-subtle bg-surface-panel">
    <div className="grid h-[37px] grid-cols-2 border-b border-border-subtle bg-surface-panel text-[12px] font-semibold min-[1280px]:h-[38px]"><div className="flex items-center justify-between border-r border-border-subtle px-3 max-[1279px]:min-w-0"><span className="flex items-center gap-1.5 text-good max-[1279px]:min-w-0 max-[1279px]:flex-1 max-[1279px]:overflow-hidden"><span className="max-[1279px]:min-w-0 max-[1279px]:truncate max-[1279px]:whitespace-nowrap">▲ {labels.positive}</span><span className="rounded-[3px] bg-surface-container px-1.5 py-0.5 text-[10px] text-text-muted max-[1279px]:shrink-0">量级榜</span></span><small className="font-mono text-[9px] font-normal text-text-muted/60 max-[1279px]:ml-1 max-[1279px]:shrink-0">{amountUnit}</small></div><div className="flex items-center justify-between px-3 max-[1279px]:min-w-0"><span className="flex items-center gap-1.5 text-risk max-[1279px]:min-w-0 max-[1279px]:flex-1 max-[1279px]:overflow-hidden"><span className="max-[1279px]:min-w-0 max-[1279px]:truncate max-[1279px]:whitespace-nowrap">▼ {labels.negative}</span><span className="rounded-[3px] bg-surface-container px-1.5 py-0.5 text-[10px] text-text-muted max-[1279px]:shrink-0">量级榜</span></span><small className="font-mono text-[9px] font-normal text-text-muted/60 max-[1279px]:ml-1 max-[1279px]:shrink-0">{amountUnit}</small></div></div>
    ...
    <div className="grid h-[40px] grid-cols-2 border-y border-border-subtle bg-surface-panel text-[12px] font-semibold min-[1280px]:h-[39px]"><div className="flex items-center justify-between border-r border-border-subtle px-3 max-[1279px]:min-w-0"><span className="flex items-center gap-1.5 text-good max-[1279px]:min-w-0 max-[1279px]:flex-1 max-[1279px]:overflow-hidden"><span className="max-[1279px]:min-w-0 max-[1279px]:truncate max-[1279px]:whitespace-nowrap">▲ {labels.positive}</span><span className="rounded-[3px] bg-warn/10 px-1.5 py-0.5 text-[10px] text-warn max-[1279px]:shrink-0">强度榜</span></span><small className="text-[9px] font-normal text-text-muted/60 max-[1279px]:ml-1 max-[1279px]:shrink-0">强度分</small></div><div className="flex items-center justify-between px-3 max-[1279px]:min-w-0"><span className="flex items-center gap-1.5 text-risk max-[1279px]:min-w-0 max-[1279px]:flex-1 max-[1279px]:overflow-hidden"><span className="max-[1279px]:min-w-0 max-[1279px]:truncate max-[1279px]:whitespace-nowrap">▼ {labels.negative}</span><span className="rounded-[3px] bg-warn/10 px-1.5 py-0.5 text-[10px] text-warn max-[1279px]:shrink-0">强度榜</span></span><small className="text-[9px] font-normal text-text-muted/60 max-[1279px]:ml-1 max-[1279px]:shrink-0">强度分</small></div></div>
