...
from ..decision_model import MODEL_VERSION, enhance_signal_with_decision, evaluate_decision
...
def _decision_payload_from_items(
    *,
    ...
    return redact_api_payload(result)
...
def decision_for_symbol_payload(
    ...
    *,
    ...
    if not normalized:
        return api_error("请输入币种，例如 BTC 或 BTCUSDT", code="bad_request")
